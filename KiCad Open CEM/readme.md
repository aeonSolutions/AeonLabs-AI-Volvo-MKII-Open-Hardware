[Main Page](https://github.com/aeonSolutions/AeonLabs-AI-Volvo-MKII-Open-Hardware/wiki)  >>  KiCad project files for the OPEN Central Electronic Module (CEM)
...
This folder contains the KiCad Project files, for the hardware electronics of the OPEN Central Electronic Module (CEM).  Each KiCad project is available with a [creative commons share alike non-commercial license](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.en). 
